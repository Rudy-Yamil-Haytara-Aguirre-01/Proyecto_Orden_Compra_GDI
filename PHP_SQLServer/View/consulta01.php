  ...
  <body>
    <div class="col-md-8 col-md-offset-2">
      ...
      <table class="table table-bordered table-responsive">
        <form method="POST" action="consulta01.php">
          <div class="form-group">
            <label>Codigo Articulo</label>
              <input type="text" name="Cod_A" class="form-control" placeholder="ingrese codigo del articlo"><br />
          </div>
          <div class="form-group">
        ...
        <tr>
          <td>Articulo</td>
          <td>Proveedor</td>
          <td>localidad del Proveedor</td>
        </tr>
        <?php

          if(isset($_POST['enviar'])){

            $articulo = $_POST['Cod_A'];

            include_once("../conexion.php");

            $consulta = "EXECUTE sp_buscar_provedor_por_articulo '$articulo'";
            ...
            $ubicaion = $fila['ciudad'];           
            $i++;
        ?>
        <tr align="center">
          <td><?php echo $Nombre; ?></td>
          <td><?php echo $empresa; ?></td>
          <td><?php echo $ubicaion; ?></td>            
        </tr>
