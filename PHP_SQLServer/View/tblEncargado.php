...
<html lang="en">
  ...
  <body>
    <div class="col-md-8 col-md-offset-2">
      ...
      <table class="table table-bordered table-responsive">
        ...
        <tr align="center">
          ...
          <td><a href="../controller/EDIT_ENCARGADO.php?editar=<?php echo $RUC; ?>">EDITAR</a></td>
          <td><a href="../controller/DELETE_ENCARGADO.php?borrar=<?php echo $RUC; ?>">BORRAR</a></td>
    ...
    <div class="col-md-8 col-md-offset-2">
      <form action="../controller/INSERT_ENCARGADO.php">
