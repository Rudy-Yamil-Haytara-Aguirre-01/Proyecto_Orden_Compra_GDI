    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <table class="table table-bordered table-responsive">
        ...
        <tr align="center">
          ...
          <td><?php echo $codigo_A; ?></td>
          <td><?php echo $cantidad; ?></td>
          <td><?php echo $subtotal; ?></td>
          <td><a href="../controller/EDIT_INCLUYE.php?editar=<?php echo "$nro_orden " ; echo "$codigo_A"; ?>">EDITAR</a></td>
          <td><a href="../controller/DELETE_INCLUYE.php?borrar=<?php echo "$nro_orden " ; echo "$codigo_A" ?>">BORRAR</a></td>
     ...
     <div class="col-md-8 col-md-offset-2">
         <form action="../controller/INSERT_INCLUYE.php">
