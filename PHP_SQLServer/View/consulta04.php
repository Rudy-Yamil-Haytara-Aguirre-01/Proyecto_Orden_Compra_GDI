  ...
  <body>
    <div class="col-md-8 col-md-offset-2">
      ...
      <table class="table table-bordered table-responsive">
        <form method="POST" action="consulta04.php">
          <div class="form-group">
            <label>Codigo</label>
              <input type="text" name="codigo" class="form-control" placeholder="ingrese del codigo del articulo"><br />
          </div>
          <div class="form-group">
        ...
        <?php
          ...
          if(isset($_POST['enviar'])){
            ...
            $consulta = "EXECUTE sp_Stock_de_Articulo '$cod_A'";
            ...
            $nomb_art  = $fila['nombre_articulo'];
            $stock = $fila['stock'];           
            $i++;
        ?>
        <tr align="center">
          <td><?php echo $nomb_art; ?></td>
